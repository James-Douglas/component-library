...
<Meta title="Components/Dropdown/Dropdown" component={Dropdown} />
                ...
                <Column>
                  <div style={{ marginBottom: '40px', width: '100%' }}>
                    <Dropdown
                      ...
                      handleChange={(event, value, option) => { console.log(`option: ${option}, value: ${value}`); }}
                  ...
                  <div style={{ marginBottom: '40px', width: '100%' }}>
                    <Dropdown
                      id="input-two"
                      label="Dropdown Label"
                      tooltip={{ trackingLabel: 'another dropdown tooltip',title: 'A dropdown tooltip too!', body: 'Woo-hoo' }}
                      handleChange={(event, value, option) => { console.log(`option: ${option}, value: ${value}`); }}
                      variant="text"
...
<Story name="Dropdown with props" decorators={[withKnobs]} parameters={{ docs: { disable: true } }}>
  {() => {
    ...
    const dropdownVariant = select('variant', ['default', 'text', 'text-fixed-chevron'], 'default', componentPropsId);
    const className = text('className', '', componentPropsId);
    const DropdownItemClassName = text('DropdownItemClassName', '', componentPropsId);
          ...
          <Row>
            <Column>
              <Dropdown
                ...
                handleChange={(event, value, option) => { console.log('VALUE:', value, 'OPTION:', option); }}
                handleFocus={() => { console.log('dropdown was focused') }}
                handleBlur={() => { console.log('dropdown lost focus') }}
                className={className}
              >
                <DropdownItem DropdownItemClassName={DropdownItemClassName} value="Default">Default Item - Title</DropdownItem>
                <DropdownItem DropdownItemClassName={DropdownItemClassName} value="First">First Item - Title</DropdownItem>
                <DropdownItem DropdownItemClassName={DropdownItemClassName} value="Second">Second Item - Title</DropdownItem>
                <DropdownItem DropdownItemClassName={DropdownItemClassName} value="Third">Third Item - Title</DropdownItem>
                <DropdownItem DropdownItemClassName={DropdownItemClassName} value="TRex">Tyrannosaurus Rex</DropdownItem>
                <DropdownItem DropdownItemClassName={DropdownItemClassName} value="Tutu">Tutu Train</DropdownItem>
              </Dropdown>
            </Column>
          </Row>
        </FluidContainer>
