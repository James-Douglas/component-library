  ...
  {() => {
    ...
    return (
      <div style={{ padding: '10%' }}>
        <StepSlider
          trackingLabel="How much cover do you want?"
          name="test-slider"
          value={value}
          marks={marks}
          ...
          tooltip={{
            trackingLabel: 'coverage tooltip',
            title: 'Coverage',
...
<Story name="step slider with props" decorators={[withKnobs]} parameters={{ docs: { disable: true } }}>
  {() => {
    ...
    const sortOrderAscending = boolean('Sort order ascending', true, componentPropsId);
    const [value, setValue] = useState(5000);
    const marks = [
      {
        value: 0,
...
{() => {
  ...
  return (
    <div style={{ padding: '10%', background: '#F3F3F3' }}>
      <div>
        <StepSlider
          trackingLabel="test-cancellation"
          ...
          tooltip={{
            trackingLabel: 'cancellation tooltip',
            title: 'Cancellation',
      ...
      <div>
        <StepSlider
          ...
          tooltip={{
            trackingLabel: 'car rental excess tooltip',
      ...
      <div>
        <StepSlider
          ...
          tooltip={{
            trackingLabel: 'additional excess tooltip',
      ...
      <div>
        <StepSlider
          trackingLabel="test-excess"
          name="test-excess"
          value={excess}
          marks={excessMarks}
          sortOrderAscending={false}
          onChange={(e, newValue) => handleChange(e, 'excess', newValue)}
          label={(<>Minimum amount of cover for <strong>excess</strong> (Sorted Descending)</>)}
          tooltip={{
            trackingLabel: 'excess tooltip',
            title: 'Excess',
            body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
          }}
        />
