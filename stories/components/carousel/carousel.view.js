...
import { StyledActions, StyledPreviousButton, StyledNextButton, StyledCompleteButton } from './carousel.styles';
    ...
    <FluidContainer>
      <Row>
        <Column>
          <Carousel
              id="carousel-1"
              trackingLabel="carousel-1-tracking"
              onActiveIndexChanged={setCarouselIndex}
              carouselIndex={carouselIndex}
              className='carousel_1_class'
          >
            {getPages()}
          </Carousel>
        </Column>
      ...
      <Row>
        <Column xsOffset={4} xs={4} sm={4} md={4} lg={4}>
          <Button id="demo-1-btn" variant="secondary" handleClick={() => open(1)} trackingLabel="test">
            Mock carousel with action buttons in the WizardModal
          </Button>
        </Column>
        <WizardModal
          id="wizard-modal-1"
          trackingLabel="wizard-modal-1-tracking"
          visible={visibleIndex == 1}
          onClose={closeModals}          
        >
          <Carousel
            id="carousel-2"
            trackingLabel="carousel-2-tracking"
            onActiveIndexChanged={setCarouselIndex}
            carouselIndex={carouselIndex}
          >
            {getPages()}
