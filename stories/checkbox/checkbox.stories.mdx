          ...
          <Container>
            <Row>
              ...
              <Column cols={4}>
                ...
                <Checkbox id="chk4" label="An errored checkbox" validationMessage={error} handleChange={(id, value) => { handler(id, value)} }/>
              </Column>
              <Column cols={4}>
          ...
          <Column>
            ...
            >
             ...
             <CheckboxGroup
              ...
              handleChange={(checkboxes) => {console.warn(checkboxes)}}
            >
              <Checkbox id="x-1" label="One" />
              <Checkbox id="x-2" label="Two" />
              <Checkbox id="x-3" label="Three" />
              <Checkbox id="x-4" label="Four" />
            </CheckboxGroup>
          </Column>
        </Row>
      </Container>
        ...
        <Row>
          <Column>
             <CheckboxGroup
              ...
              handleChange={(checkboxes) => {console.warn(checkboxes)}}
            >
              <Checkbox disabled="true" id="b-1" label="One - disabled" variant="boxed" />
              <Checkbox id="b-2" image={sergei} label="Two with an image" variant="boxed" />
              <Checkbox id="b-3" label="Three" variant="boxed" />
              <Checkbox id="b-4" label="This is a very long label. This is a very long label. This is a very long label. This is a very long label. This is a very long label. This is a very long label. This is a very long label. This is a very long label. This is a very long label." variant="boxed"/>
            </CheckboxGroup>
          </Column>
        </Row>
      </Container>
