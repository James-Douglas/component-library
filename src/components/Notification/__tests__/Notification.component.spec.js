...
describe('Notification()', () => {
  ...
  it('Notification variant success', () => {
    ...
    expect(childDiv).toHaveStyleRule('border-left', `0.4rem solid ${theme.colors.success500}`);
    expect(childDiv).toHaveStyleRule('box-shadow', theme.notification.shadow);
    expect(dangerIcon).toBeInTheDocument();
  });
  ...
  it('renders a hint notification', () => {
    ...
    expect(childDiv).not.toHaveStyleRule('min-width', `${theme.minWidth.xs}`);
    expect(childDiv).not.toHaveStyleRule('box-shadow', theme.notification.shadow);
    expect(childDiv).toHaveStyleRule('border-left', `0.4rem solid ${theme.colors.primary500}`);
