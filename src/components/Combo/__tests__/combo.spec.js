...
describe('Combo', () => {
  ...
  it('renders correct without blue band', () => {
    const { container } = render(<Combo prefillValue="pre" label="First Combo label" apiData={apiData} id="combo-id-first" linkHref="https://www.comparethemarket.com.au/" linkText="Can’t find your address?" required={false} characterMinimum={5} />);
    const link = container.getElementsByTagName('a')[0];
