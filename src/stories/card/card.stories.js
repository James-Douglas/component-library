...
storiesOf('Card', module)
  ...
  .add('Single card', () => <Container><Card>this is a test</Card></Container>, {})
  .add('Card Group', () => {
    ...
    return (
      <CardGroup cols={cols}>
        ...
        {cards.map((card) => <Card><div className="flex w-full h-full items-center justify-center"><h2>{card}</h2></div></Card>)}
      </CardGroup>
    );
  })
  .add('Mock results', () => {
