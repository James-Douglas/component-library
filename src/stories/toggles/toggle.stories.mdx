...
<Preview>
  <Story name="square toggles">
    {() => {
      ...
      return (
        <Container>
          <ToggleGroup label="Square toggles" name="toggleGroupA" tooltip={tooltip} onToggle={onToggle}>
...
<Preview>
  <Story name="rectangle toggles">
    {() => {
      ...
      return (
        <Container>
          <ToggleGroup label="Rectangle toggles" name="toggleGroupD" tooltip={tooltip} onToggle={onToggle}>
...
<Preview>
  <Story name="toggles with icons">
    {() => {
      ...
      return (
        <Container>
          <ToggleGroup label="Icons" name="toggleGroupB" tooltip={tooltip} onToggle={onToggle}>
...
<Preview>
  ...
  {() => {
    ...
    return (
      <Container>
        <ToggleGroup label="Images" name="toggleGroupC" tooltip={tooltip} onToggle={onToggle}>
          {makes.map((make, i) => (
...
<Preview>
  <Story name="custom toggle demo" >
    {() => {
      ...
      return (
         <Container>
           <ToggleGroup label="Medicare toggles" name="toggleGroupA" tooltip={tooltip} onToggle={(value) => console.log(`TOGGLE SELECTED: ${value} `)}>
             <CustomToggle
               name="image"
               id="green"
               value="green"
...
<Preview>
  <Story name="color toggle">
    {() => {
      ...
      return (
        <Container>
          <ToggleGroup label="Default" name="toggleGroupA" tooltip={tooltip} onToggle={onToggle}>
