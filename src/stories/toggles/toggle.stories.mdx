...
The Toggle component can be used to allow users to select from a predefined set of options, typically in response to a
question within a journey form. Manor exposes three Toggle components, documented below. All Toggles are typically
wrapped inside a ToggleGroup which manages labels, validation, tooltips, and selection events.
