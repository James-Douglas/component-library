...
<Preview>
  <Story name="square toggles">
    {() => {
      ...
      const onToggle = () => {};
      return (
        <ToggleGroup label="Square toggles" name="toggleGroupA" tooltip={tooltip} onToggle={onToggle} disableFieldset>
...
<Preview>
  <Story name="rectangle toggles">
    {() => {
      ...
      const onToggle = () => {};
      return (
        <ToggleGroup label="Rectangle toggles" name="toggleGroupD" tooltip={tooltip} onToggle={onToggle} disableFieldset>
...
<Preview>
  <Story name="toggles with icons">
    {() => {
      ...
      const onToggle = () => {};
      return (
        <ToggleGroup label="Icons" name="toggleGroupB" tooltip={tooltip} onToggle={onToggle} disableFieldset>
...
<Preview>
  ...
  {() => {
    ...
    const onToggle = () => {};
    return (
      <ToggleGroup label="Images" name="toggleGroupC" tooltip={tooltip} onToggle={onToggle} disableFieldset>
        {makes.map((make, i) => (
...
<Preview>
  <Story name="color toggle">
    {() => {
      ...
      const onToggle = () => {};
      return (
        <ToggleGroup label="Default" name="toggleGroupA" tooltip={tooltip} onToggle={onToggle} disableFieldset>
