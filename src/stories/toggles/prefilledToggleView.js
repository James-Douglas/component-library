...
const PrefilledToggleView = () => {
  ...
  return (
    <StoryTemplate>
      <div className="mb-32">
        <ToggleGroup label="Pre-checked" id="toggleGroupG" name="toggleGroupF" tooltip={tooltip} onToggle={handleChange} prefillValue="d">
...
export default PrefilledToggleView;
