  ...
  .add('Default', () => (
    <div>
      <div style={{ height: '120px' }}>
        ...
        <StickyTracker value="60" steps={[{ label: 'About You', url: '#label' }, { label: 'Your Cover', url: '#another' }, { label: 'Your Details', url: '#one-more', active: true }, { label: 'Compare Cover', url: '#again', disabled: true }, { label: 'Purchase Cover', url: '#again', disabled: true }]} />
      </div>
      <FluidContainer>
