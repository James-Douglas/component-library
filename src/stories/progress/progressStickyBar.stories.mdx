...
import StickyProgressBar from '../../components/Progress/Bar/StickyProgressBar.component';
import Header from '../../components/Header/Header.component';
import FluidContainer from '../../components/Grid/Container/Fluid.component';

<Meta title="Components|Progress/StickyBar" component={StickyProgressBar} />
...
<Story name="sticky progress bar" decorators={[withKnobs]} parameters={{ docs: { disable: true } }}>
  <div style={{maxWidth: '100%'}}>
    <StickyProgressBar value={50} />
  </div>
</Story>

## Props
<Props of={StickyProgressBar} />
