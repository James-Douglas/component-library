...
<Story name="sticky progress tracker" decorators={[withKnobs]} parameters={{ docs: { disable: true } }}>
  <div style={{maxWidth: '100%'}}>
    <StickyTracker steps={[{ label: 'About You', url: '#label', active: true }, { label: 'About me', url: '#label' }, { label: 'About us', url: '#label' }, { label: 'About them', url: '#label' } ]} />
  </div>
</Story>
    ...
    return (
      <div>
        <div style={{ height: '120px' }}>
          ...
          <StickyTracker value={value} steps={steps} />
        </div>
        <FluidContainer>
