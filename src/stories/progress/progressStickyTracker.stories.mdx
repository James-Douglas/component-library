...
import StickyProgressTracker from '../../components/Progress/Tracker/StickyProgressTracker.component';
import Header from '../../components/Header/Header.component';
import FluidContainer from '../../components/Grid/Container/Fluid.component';

<Meta title="Components|Progress/StickyTracker" component={StickyProgressTracker} />

# Sticky Progress Tracker

**Switch to canvas view to see examples**

<Story name="sticky progress tracker" decorators={[withKnobs]} parameters={{ docs: { disable: true } }}>
  <div style={{maxWidth: '100%'}}>
    <StickyProgressTracker steps={[{ label: 'About You', url: '#label', active: true }, { label: 'About me', url: '#label' }, { label: 'About us', url: '#label' }, { label: 'About them', url: '#label' } ]} />
  </div>
</Story>

## Props
<Props of={StickyProgressTracker} />

<Story name="sticky progress tracker with props" decorators={[withKnobs]} parameters={{ docs: { disable: true } }}>
  {() => {
    ...
    return (
      <div>
        <div style={{ height: '120px' }}>
          ...
          <StickyProgressTracker value={value} steps={steps} />
        </div>
        <FluidContainer >
          <div>
            <div className="hero">
