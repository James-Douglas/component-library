...
const SliderBottom = () => {
  ...
  return (
    <div className="manor-rich-text">
      ...
      {show && <Overlay opacityLevel={0} onClose={onClose} />}
      <Slider
        notificationSize={`${breakpoint === 'xs' || breakpoint === 'sm' ? '100%' : '110px'}`}
        show={show}
        direction="bottom"
              ...
              <Column col="12" sm="12" md="12">
                <Container>
                  <Row className="row-view">
                    <Column col="12">
                      <div className="manor-rich-text">
                        <div className={`flex ${breakpoint === 'xs' || breakpoint === 'sm' ? 'flex-col' : 'justify-between items-center'}`}>
                          <h4 className={`${breakpoint === 'xs' || breakpoint === 'sm' ? 'mb-24' : ''}`}>Compare Personal Loans</h4>
                          <div className={`${breakpoint === 'xs' || breakpoint === 'sm' ? 'mb-24' : ''}`}>
                            <ToggleGroup
                              name="toggleGroupE"
                          ...
                          <Button id="secondary-btn02" type="secondary" size="md" content="Compare Personal Loans" disabled={false} />
                        </div>
                      </div>
                    </Column>
                  </Row>
