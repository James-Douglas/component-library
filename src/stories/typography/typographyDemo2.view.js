...
const TypographyDemo2 = () => (
  <>
    <div className="w-auto">
      <div className="section white-bg">
        <Container>

          <div className="manor-overline manor-header-spacing">h1. Heading 1</div>
          <h1 className="manor-h1 manor-heading-spacing" title=".manor-h1">Compare The Market</h1>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">h2. Heading 2</div>
          <h2 className="manor-h2 manor-heading-spacing" title=".manor-h2">Compare The Market</h2>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">h3. Heading 3</div>
          <h3 className="manor-h3 manor-heading-spacing" title=".manor-h3">Compare The Market</h3>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">h4. Heading 4</div>
          <h4 className="manor-h4 manor-heading-spacing" title=".manor-h4">Compare The Market</h4>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">h5. Heading 5</div>
          <h5 className="manor-h5 manor-heading-spacing" title=".manor-h5">Compare The Market</h5>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">h6. Heading 6</div>
          <h6 className="manor-h6 manor-heading-spacing" title=".manor-h6">Compare The Market</h6>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">Subtitle 1</div>
          <div className="manor-subtitle1 manor-heading-spacing" title=".manor-subtitle1">Compare The Market</div>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>

          <div className="manor-overline manor-header-spacing">Subtitle 2</div>
          <div className="manor-subtitle2 manor-heading-spacing" title=".manor-subtitle2">Compare The Market</div>
          <p className="manor-body1">Bacon ipsum dolor amet pork chop buffalo biltong leberkas pork belly alcatra tongue. Salami pork belly tail pork chop beef ribs, shoulder picanha. Pork bresaola cow shank fatback chuck pastrami t-bone prosciutto. Pork loin short loin cupim corned beef. Shank hamburger strip steak, turkey chuck frankfurter doner.</p>
          ...
          <div className="manor-overline manor-header-spacing">Unordered list</div>
...
Example:
          ...
          <div className="manor-overline manor-header-spacing">Ordered list</div>
...
Example:
          ...
          <div className="manor-overline manor-header-spacing">Unordered list within Body 1</div>
...
Chocolate dessert bonbon fruitcake. Pudding brownie cake jelly-o topping ice cream. Macaroon lollipop muffin candy toffee jelly marshmallow. Jelly beans tootsie roll cupcake muffin. Sugar plum liquorice macaroon wafer dragée tiramisu sweet gummi bears icing. Pudding caramels bear claw.
          ...
          <div className="manor-overline manor-header-spacing">Ordered list within Body 2</div>
...
Chocolate dessert bonbon fruitcake. Pudding brownie cake jelly-o topping ice cream. Macaroon lollipop muffin candy toffee jelly marshmallow. Jelly beans tootsie roll cupcake muffin. Sugar plum liquorice macaroon wafer dragée tiramisu sweet gummi bears icing. Pudding caramels bear claw.
          ...
          <div className="manor-overline manor-header-spacing">body 1 text within paragraph tag + body 1 text within paragraph tag</div>
          ...
          <div className="manor-overline manor-header-spacing">body 2 text within paragraph tag + body 2 text within paragraph tag</div>
...
export default TypographyDemo2;
