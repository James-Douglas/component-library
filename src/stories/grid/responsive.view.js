    ...
    <div className="grid-view">
      <Container>
        ...
        <div className="background-wrap">
          ...
          <Row className="row-view">
            <Column className="col-view" sm="8">sm=&apos;8&apos;</Column>
            <Column className="col-view" sm="4">sm=&apos;4&apos;</Column>
          </Row>
          <Row className="row-view">
            <Column className="col-view" col="sm">col=&apos;sm&apos;</Column>
            <Column className="col-view" col="sm">col=&apos;sm&apos;</Column>
            <Column className="col-view" col="sm">col=&apos;sm&apos;</Column>
          </Row>
          <Row className="row-view">
          ...
          <Row className="row-view">
            <Column className="col-view" sm="4" lg="2">sm=&apos;4&apos; lg=&apos;2&apos;</Column>
            <Column className="col-view" sm="4" lg="2">sm=&apos;4&apos; lg=&apos;2&apos;</Column>
            <Column className="col-view" sm="4" lg="8">sm=&apos;4&apos; lg=&apos;8&apos;</Column>
          </Row>
        </div>
      </Container>
    </div>
