...
const ctmTheme = {
  ...
  checkbox: {
    ...
    contentMargin: `0 ${spacing[8]}`,
    boxedShadow: '0 3px 8px rgba(0, 0, 0, 0.1)',
  },
  container: {
    maxWidth: '120rem',
  },
  ...
  datepicker: {
    ...
    datepickerDayColor: colors.grey700,
    datepickerDayColorSelected: colors.white,
    datepickerDayBackground: colors.primary500,
  ...
  tag: {
    background: colors.primary50,
    alert: colors.warning50,
    alertTextColor: colors.warning700,
    alertHover: `1px solid ${colors.warning700}`,
    altAlert: colors.error50,
    altAlertTextColor: colors.error700,
    altAlertHover: `1px solid ${colors.error500}`,
    regHover: `1px solid ${colors.primary300}`,
    height: '100px',
  },
  breakpoints,
  borders,
